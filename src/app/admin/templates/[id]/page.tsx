    ...
    <div>
      ...
      <form action={renameTemplate} className="mb-6 flex gap-3 items-center">
        ...
        <input
          ...
          className="text-2xl font-bold bg-transparent border-0 border-b border-gray-300 focus:border-[#832b2b] focus:outline-none px-1 flex-1"
        />
      ...
      <section className="mb-8">
        ...
        <form
          ...
          className="bg-white border border-gray-200 rounded-xl p-5 grid grid-cols-1 md:grid-cols-[120px_120px_1fr_120px_auto] gap-3"
        >
                ...
                <div className="px-5 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
                  ...
                  <form action={deleteTemplateItem}>
                    ...
                    <input
                      ...
                      value={template.id}
                    />
                    <SubmitButton className="text-xs text-red-600 hover:bg-red-50 px-2 py-1 rounded-lg cursor-pointer">
                      Remove Mass
                    </SubmitButton>
                  </form>
                </div>
                    ...
                    .map((slot) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          className="w-16 bg-gray-100 border border-gray-300 rounded-lg px-2 py-1 text-sm"
                        />
                        <SubmitButton className="text-xs px-3 py-1.5 bg-gray-100 hover:bg-gray-200 rounded-lg cursor-pointer">
                          Save
                        </SubmitButton>
